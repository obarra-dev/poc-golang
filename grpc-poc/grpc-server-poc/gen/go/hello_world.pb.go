...
type HelloRequest struct {
	...
	//  Optional filter
	Filters *GetVendorsOfVenuesRequestFilters `protobuf:"bytes,3,opt,name=filters,proto3" json:"filters,omitempty"`
}
...
func (x *HelloRequest) GetFilters() *GetVendorsOfVenuesRequestFilters {
	if x != nil {
		return x.Filters
	}
	return nil
...
type GetVendorsOfVenuesRequestFilters struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetVendorsOfVenuesRequestFilters) Reset() {
	*x = GetVendorsOfVenuesRequestFilters{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetVendorsOfVenuesRequestFilters) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetVendorsOfVenuesRequestFilters) ProtoMessage() {}

func (x *GetVendorsOfVenuesRequestFilters) ProtoReflect() protoreflect.Message {
	mi := &file_hello_world_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetVendorsOfVenuesRequestFilters.ProtoReflect.Descriptor instead.
func (*GetVendorsOfVenuesRequestFilters) Descriptor() ([]byte, []int) {
	return file_hello_world_proto_rawDescGZIP(), []int{2}
}

func (x *GetVendorsOfVenuesRequestFilters) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
var file_hello_world_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x04, 0x6d, 0x61, 0x72, 0x75, 0x22, 0x64, 0x0a, 0x0c, 0x48, 0x65, 0x6c,
	...
	0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26,
	0x2e, 0x6d, 0x61, 0x72, 0x75, 0x2e, 0x47, 0x65, 0x74, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x73,
	0x4f, 0x66, 0x56, 0x65, 0x6e, 0x75, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x46,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x3a, 0x0a, 0x20, 0x47, 0x65, 0x74, 0x56, 0x65,
	0x6e, 0x64, 0x6f, 0x72, 0x73, 0x4f, 0x66, 0x56, 0x65, 0x6e, 0x75, 0x65, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x22, 0x53, 0x0a, 0x12, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d, 0x61,
	...
	,
...
var file_hello_world_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_hello_world_proto_goTypes = []interface{}{
	(*HelloRequest)(nil),                     // 0: maru.HelloRequest
	(*HelloReply)(nil),                       // 1: maru.HelloReply
	(*GetVendorsOfVenuesRequestFilters)(nil), // 2: maru.GetVendorsOfVenuesRequestFilters
	(*UploadImageRequest)(nil),               // 3: maru.UploadImageRequest
	(*UploadImageResponse)(nil),              // 4: maru.UploadImageResponse
}
var file_hello_world_proto_depIdxs = []int32{
	2, // 0: maru.HelloRequest.filters:type_name -> maru.GetVendorsOfVenuesRequestFilters
	0, // 1: maru.Greeter.SayHello:input_type -> maru.HelloRequest
	3, // 2: maru.ImageService.UploadImage:input_type -> maru.UploadImageRequest
	1, // 3: maru.Greeter.SayHello:output_type -> maru.HelloReply
	4, // 4: maru.ImageService.UploadImage:output_type -> maru.UploadImageResponse
...
func file_hello_world_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_hello_world_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetVendorsOfVenuesRequestFilters); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_hello_world_proto_msgTypes[3].OneofWrappers = []interface{}{
